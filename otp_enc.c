...
//
//    This file contains code that is specific to the encoding client.
//
// *****************************************************************************
//
...
#define CLI_TYPE 1   // 1 = encode, 0 = decode
...
int main(int argc, char **argv)
{
    ...
    struct sockaddr_in myServ;      // Information describing server socket
